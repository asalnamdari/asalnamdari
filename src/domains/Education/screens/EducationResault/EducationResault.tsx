...
import messages from './EducationResault.messages'
import useEducationResultStyle from './useEducationResaultStyle'

const EducationResult: FC = () => {
  const classes = useEducationResultStyle()
  ...
  return (
    <div className={classes.root}>
      ...
      <Button
        ...
        onClick={() => push('/education/degrees')}
        size="large"
      >
